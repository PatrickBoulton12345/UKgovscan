...
export const COUNCILS: Council[] = [
  // London Boroughs
  withSlugAndRevenue('Barnet', 'London', 'London Borough', { incidents: 6938, fpns: 409, rate: 5.90 }, { expenditure: 769_481_000, councilTax: 229_355_382, parkingIncome: 27_267_000, parkingSurplus: 15_334_000, businessRates: 81_686_000, govGrants: 434_939_000, feesCharges: 99_326_000 }),
  withSlugAndRevenue('Camden', 'London', 'London Borough', { incidents: 36216, fpns: 1169, rate: 3.23 }, { expenditure: 663_527_000, councilTax: 141_130_750, parkingIncome: 49_849_000, parkingSurplus: 32_280_000, businessRates: 108_192_000, govGrants: 369_983_000, feesCharges: 118_279_000 }),
  withSlugAndRevenue('Croydon', 'London', 'London Borough', { incidents: 53268, fpns: 23, rate: 0.04 }, { expenditure: 760_972_000, councilTax: 259_761_448, parkingIncome: 28_223_000, parkingSurplus: 18_582_000, businessRates: 99_251_000, govGrants: 365_263_000, feesCharges: 156_348_000 }),
  ...
  withSlugAndRevenue('Hackney', 'London', 'London Borough', { incidents: 31042, fpns: 106, rate: 0.34 }, { expenditure: 780_108_000, councilTax: 109_337_928, parkingIncome: 32_858_000, parkingSurplus: 15_325_000, businessRates: 169_467_000, govGrants: 457_128_000, feesCharges: 140_969_000 }),
  ...
  withSlugAndRevenue('Leeds', 'Yorkshire', 'Metropolitan', { incidents: 13923, fpns: 83, rate: 0.60 }, { expenditure: 1_700_063_000, councilTax: 421_490_714, parkingIncome: 13_102_000, parkingSurplus: 7_524_000, businessRates: 234_446_000, govGrants: 1_003_475_000, feesCharges: 156_299_000 }),
  withSlugAndRevenue('Manchester', 'North West', 'Metropolitan', { incidents: 14963, fpns: 992, rate: 6.63 }, { expenditure: 1_327_674_000, councilTax: 229_259_492, parkingIncome: 39_764_000, parkingSurplus: 19_480_000, businessRates: 435_631_000, govGrants: 629_145_000, feesCharges: 198_300_000 }),
  withSlugAndRevenue('Liverpool', 'North West', 'Metropolitan', { incidents: 20300, fpns: 0, rate: 0.00 }, { expenditure: 1_345_120_000, councilTax: 235_103_456, parkingIncome: 16_111_000, parkingSurplus: 5_450_000, businessRates: 357_806_000, govGrants: 713_720_000, feesCharges: 124_659_000 }),
  withSlugAndRevenue('Sheffield', 'Yorkshire', 'Metropolitan', { incidents: 12237, fpns: 129, rate: 1.05 }, { expenditure: 1_164_879_000, councilTax: 284_713_441, parkingIncome: 9_728_000, parkingSurplus: 4_899_000, businessRates: 208_412_000, govGrants: 659_524_000, feesCharges: 145_179_000 }),
  withSlugAndRevenue('Bradford', 'Yorkshire', 'Metropolitan', { incidents: 19697, fpns: 91, rate: 0.46 }),
  withSlugAndRevenue('Coventry', 'West Midlands', 'Metropolitan', { incidents: 7188, fpns: 199, rate: 2.77 }, { expenditure: 686_129_000, councilTax: 175_897_581, parkingIncome: 8_909_000, parkingSurplus: 3_162_000, businessRates: 132_882_000, govGrants: 374_970_000, feesCharges: 101_100_000 }),
  withSlugAndRevenue('Newcastle upon Tyne', 'North East', 'Metropolitan', { incidents: 16731, fpns: 157, rate: 0.94 }, { expenditure: 599_512_000, councilTax: 140_584_999, parkingIncome: 25_166_000, parkingSurplus: 11_408_000, businessRates: 113_412_000, govGrants: 330_590_000, feesCharges: 129_937_000 }),
  withSlugAndRevenue('Sunderland', 'North East', 'Metropolitan', { incidents: 9481, fpns: 95, rate: 1.00 }, { expenditure: 551_071_000, councilTax: 128_086_782, parkingIncome: 4_136_000, parkingSurplus: 545_000, businessRates: 119_018_000, govGrants: 303_372_000, feesCharges: 84_289_000 }),
  ...
  // Unitary
  withSlugAndRevenue('Bristol', 'South West', 'Unitary', { incidents: 10266, fpns: 217, rate: 2.11 }, { expenditure: 881_082_000, councilTax: 282_398_335, parkingIncome: 23_162_000, parkingSurplus: 12_446_000, businessRates: 186_494_000, govGrants: 415_887_000, feesCharges: 248_844_000 }),
  withSlugAndRevenue('Brighton and Hove', 'South East', 'Unitary', { incidents: 1627, fpns: 390, rate: 23.97 }, { expenditure: 621_633_000, councilTax: 185_147_980, parkingIncome: 50_950_000, parkingSurplus: 33_231_000, businessRates: 83_789_000, govGrants: 356_651_000, feesCharges: 137_677_000 }),
  withSlugAndRevenue('Milton Keynes', 'South East', 'Unitary', { incidents: 4258, fpns: 115, rate: 2.70 }),
  withSlugAndRevenue('Reading', 'South East', 'Unitary', { incidents: 2229, fpns: 221, rate: 9.91 }, { expenditure: 343_990_000, councilTax: 118_884_447, parkingIncome: 9_293_000, parkingSurplus: 4_255_000, businessRates: 46_747_000, govGrants: 167_743_000, feesCharges: 46_743_000 }),
  withSlugAndRevenue('Plymouth', 'South West', 'Unitary', { incidents: 5370, fpns: 281, rate: 5.23 }, { expenditure: 467_256_000, councilTax: 138_767_778, parkingIncome: 11_519_000, parkingSurplus: 3_970_000, businessRates: 84_471_000, govGrants: 222_809_000, feesCharges: 71_137_000 }),
  withSlugAndRevenue('Derby', 'East Midlands', 'Unitary', { incidents: 6477, fpns: 182, rate: 2.81 }, { expenditure: 482_142_000, councilTax: 124_961_350, parkingIncome: 8_346_000, parkingSurplus: 3_122_000, businessRates: 87_496_000, govGrants: 273_084_000, feesCharges: 71_211_000 }),
  withSlugAndRevenue('Leicester', 'East Midlands', 'Unitary', { incidents: 6966, fpns: 230, rate: 3.30 }, { expenditure: 768_088_000, councilTax: 153_587_399, parkingIncome: 9_911_000, parkingSurplus: 3_792_000, businessRates: 147_704_000, govGrants: 461_686_000, feesCharges: 92_710_000 }),
  withSlugAndRevenue('Nottingham', 'East Midlands', 'Unitary', { incidents: 26138, fpns: 973, rate: 3.72 }, { expenditure: 703_846_000, councilTax: 148_879_420, parkingIncome: 28_391_000, parkingSurplus: 19_966_000, businessRates: 131_761_000, govGrants: 456_048_000, feesCharges: 139_679_000 }),
